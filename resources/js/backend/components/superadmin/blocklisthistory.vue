                                ...
                                <tbody>
                                    ...
                                    >
                                        ...
                                        <td>
                                            <lists
                                                :lists="[
                                                    {key: '<strong>Id</strong>', value: item.userId },
                                        ...
                                        <td>
                                            <v-chip :color="item.userStatusInDevice==1 ? 'success' :'red lighten-1'" dark>
                                                {{item.userStatusInDevice==1 ? 'Activeted':'Blocked'}}
                                            </v-chip>
                                        </td>

                                        <td>
                                            {{ datetimeprocessing(item.created_at) }}
                                        </td>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getBlocklistHistory_p(page=1){
                var _this = this;
                axios.post('/api/getBlocklistHistory_p'+'?token='+ _this.token, {'page' : page,'search' : this.searchInput})
            ...
            pagechanged(page){
                this.getBlocklistHistory_p(page)
            },
